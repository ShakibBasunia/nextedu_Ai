...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "NextEdu — AI-Powered SSC Prep" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "NextEdu — AI-Powered SSC Prep" },
      { property: "og:description", content: "Adaptive Bangla learning for SSC students." },
